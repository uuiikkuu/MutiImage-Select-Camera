...
//	private static final String DEBUG = "DEBUG";
	...
	// when the image is stretched to fit com.cardapp.mainland.publibs.imagemodule.view.
	//
	...
	//
	// Size of com.cardapp.mainland.publibs.imagemodule.view and previous com.cardapp.mainland.publibs.imagemodule.view size (ie before rotation)
	//
	private int viewWidth, viewHeight, prevViewWidth, prevViewHeight;

	//
	// Size of image when it is stretched to fit com.cardapp.mainland.publibs.imagemodule.view. Before and After
	// rotation.
	//
	...
	/**
	 * Save the current matrix and com.cardapp.mainland.publibs.imagemodule.view dimensions in the prevMatrix and
	 * prevView variables.
	 */
	 ...
	 * point as a fraction from the left and top of the com.cardapp.mainland.publibs.imagemodule.view. For example, the
	...
	public void setZoom(float scale, float focusX, float focusY,
		...
		// point,
		// image and com.cardapp.mainland.publibs.imagemodule.view sizes have not yet been calculated in onMeasure. Thus,
		// we should
		// delay calling setZoom until the com.cardapp.mainland.publibs.imagemodule.view has been measured.
		//
		if (!onDrawReady) {
	 ...
	 * as a fraction from the left and top of the com.cardapp.mainland.publibs.imagemodule.view. For example, the top
	 ...
	 * a fraction from the left and top of the com.cardapp.mainland.publibs.imagemodule.view. The focus points can range
	 ...
	 * versa) the image can become unaligned within the com.cardapp.mainland.publibs.imagemodule.view. This is apparent
	 * when zooming quickly. When the content size is less than the com.cardapp.mainland.publibs.imagemodule.view size,
	 * the content will often be centered incorrectly within the com.cardapp.mainland.publibs.imagemodule.view.
	 * fixScaleTrans first calls fixTrans() and then makes sure the image is
	 * centered correctly within the com.cardapp.mainland.publibs.imagemodule.view.
	 */
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		//
		// Set com.cardapp.mainland.publibs.imagemodule.view dimensions
		//
		setMeasuredDimension(viewWidth, viewHeight);

		//
		// Fit content within com.cardapp.mainland.publibs.imagemodule.view
		//
		fitImageToView();
	}
	...
	private void fitImageToView() {
		...
		//
		// Scale image for com.cardapp.mainland.publibs.imagemodule.view
		//
		...
		if (!isZoomed() && !imageRenderedAtLeastOnce) {
			//
			// Stretch and center image to fit com.cardapp.mainland.publibs.imagemodule.view
			//
	...
	/**
	 * Set com.cardapp.mainland.publibs.imagemodule.view dimensions based on layout params
	 *
	 * @param mode
	 * @param size
	 * @param drawableWidth
	 ...
	 * @param prevViewSize
	 *            width/height of com.cardapp.mainland.publibs.imagemodule.view before rotation
	 * @param viewSize
	 *            width/height of com.cardapp.mainland.publibs.imagemodule.view after rotation
	 * @param drawableSize
	...
	private void translateMatrixAfterRotate(int axis, float trans,
		...
		if (imageSize < viewSize) {
			//
			// The width/height of image is less than the com.cardapp.mainland.publibs.imagemodule.view's width/height.
			// Center it.
			//
			...
			//
			// The image is larger than the com.cardapp.mainland.publibs.imagemodule.view, but was not before rotation.
			// Center it.
			//
			...
			// com.cardapp.mainland.publibs.imagemodule.view. Determine its distance
			// from the left/top side of the com.cardapp.mainland.publibs.imagemodule.view as a fraction of the entire
			// image's width/height. Use that percentage
			// to calculate the trans in the new com.cardapp.mainland.publibs.imagemodule.view width/height.
			//
	 ...
	 * to the com.cardapp.mainland.publibs.imagemodule.view's listener.
	 *
	 * @author Ortiz
	 *
	 */
	 ...
	 * @param clipToBitmap
	 *            Touch event may occur within com.cardapp.mainland.publibs.imagemodule.view, but outside image content.
	 ...
	 * coordinates in the drawable's coordinate system to the com.cardapp.mainland.publibs.imagemodule.view's coordinate
	 * system.
	 *
	 * @param bx
	 ...
	 * @return Coordinates of the point in the com.cardapp.mainland.publibs.imagemodule.view's coordinate system.
	 */
